  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button className='w-full bg-red-200 hover:bg-red-300 border-red-700 active:bg-red-400 transition-colors duration-100 shadow'>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            Apakah kamu yakin mau pulang sekarang?
          </AlertDialogTitle>
          <AlertDialogDescription>
            Perhatian: Setelah Anda menekan tombol Absen Pulang, data akan
            disimpan permanen. Tidak ada opsi untuk mengedit atau membatalkan.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel

      ...
      <div className='flex flex-col min-h-screen gap-4'>
        ...
        <div className='flex items-center justify-between gap-4'>
          ...
          <div className="flex items-center gap-1 text-black/40">
            ...
            <h6 className="h6">Absensi selalu dibuka pukul 08:00 - 09:00</h6>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-7 lg:gap-15 border-2 p-6 rounded-md">
          ...
          <div className="flex flex-col md:w-1/2">
            <div className="flex justify-center items-center gap-2 border-dashed border-black/30 border-2 h-[400px] w-[400px] rounded-md mb-2 bg-gray-200">
